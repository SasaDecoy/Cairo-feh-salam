% =====================================================================
%  Section 15 — Three hypothesis tests (notebook_sections figures, math-safe)
% =====================================================================
...
non-normal distributions. That is what Kruskal-Wallis is for (see
...
\begin{enumerate}
  \item 68 Greater Cairo districts from S6, with real Nominatim
        ...
        produced the very large effect we report.)
...
(very large). Pairwise Mann-Whitney with Holm correction: every pair
...
be honest about the leverage. The same data with worse spatial
...
\begin{callout}
Cliff's $\delta = -0.991$ is essentially the floor. The reading is
mechanical: the LRT was sited for a city that does not yet exist. The
planners built the rail first and bet on future settlement. That
logic may pay off as the New Administrative Capital fills, but for
2024-2026 the gap between the LRT and the people who would ride it
is the largest single mismatch in Phase 2.
\end{callout}
