...
\subsection{What this report tries to be}

The brief was simple: ``a formal report that includes every single
detail in this project with the data up to date and includes all the
visualisations in their suitable place.'' The output is roughly
eighty pages of LaTeX and 133 PNG figures across eighteen sections.
Every number cited in this document is traceable to a notebook cell
and a cleaned CSV file in \fn{CleanedData/} or \fn{Phase2/CleanedData/}.
Every figure was rendered from a notebook export in \fn{Exports/} or
\fn{Phase2/Exports/}. Every method has its calculation written out in
{\S}\ref{sec:hyp-methods}.

The story of Layla — \ar{ليلى} — is the frame, but the substance
is data. We hope this version is the one you can defend in a viva
